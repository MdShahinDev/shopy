      ...
      <div className='registerForm container mx-auto flex flex-col items-center lg:flex-row gap-4 my-8 px-4 lg:px-0'>
               ...
               <h2 className='my-4 text-center lg:text-xl'>Signup with Another Medium</h2>
                <div className="goggle-login mb-8">
                    <button className='flex w-full py-2 text-black transition-all duration-300 hover:border-black text-lg border justify-center gap-2 items-center rounded-md'><FcGoogle/>Login With Google</button>
                </div>
                <div className="github-login  mb-8">
                    <button className='flex w-full py-2 text-black transition-all duration-300 hover:border-black text-lg border justify-center gap-2 items-center rounded-md'><FaGithub/>Login With Facebook</button>
                </div>
                <div className="facebook-login mb-8">
                    <button className='flex w-full py-2 text-black transition-all duration-300 hover:border-black text-lg border justify-center gap-2 items-center rounded-md'><FaFacebook/>Login With Facebook</button>
                </div>
                </div>
            </div>
    </>
